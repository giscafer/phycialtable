package com.giscafer.phycialtable.model;
...
public class GeneratorDemo {
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.giscafer.phycialtable.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath()
				+ "/src/main/java/com/giscafer/phycialtable/model/base";
		System.out.println("路径:"+baseModelOutputDir);
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.giscafer.phycialtable.model";
		// model 文件保存路径 (MappingKit 与 DataDictionary 文件默认保存路径)
		String modelOutputDir = PathKit.getWebRootPath()
				+ "/src/main/java/com/giscafer/phycialtable/model";;
